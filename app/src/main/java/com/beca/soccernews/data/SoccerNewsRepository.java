package com.beca.soccernews.data;

import androidx.room.Room;

import com.beca.soccernews.App;
import com.beca.soccernews.data.local.SoccerNewsDb;
...
public class SoccerNewsRepository {
    ...
    //region Constantes
    private static final String REMOTE_API_URL = "https://becaalvarez.github.io/soccer-news-api/";
